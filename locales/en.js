...
notes: place 0 stands for B241, 1 for B255
       if you want to reserve by half-hour, please use \'.5\' after hour number
  ...
  'reserve_place_not_recognize': 'Place %s not found...',
...
(It may be a pity that we may not response in the first time, so sit back and relax~~ If nothing is replied after 48 hours, please send your request again, or we may never get in touch with you!
...
notes: place 0 stands for B241, 1 for B255
  ...
  'view_subtitle': '%d-%d :',
  'view_reservtion': '  %d by %s from %s to %s at %s',
